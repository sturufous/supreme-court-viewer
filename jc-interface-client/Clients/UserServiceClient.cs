...
namespace JCCommon.Clients.UserService
{
    ...
    public partial class UserServiceClient 
    {
        ...
        public virtual System.Threading.Tasks.Task<GetParticipantInfoResponse> UserGetParticipantInfoAsync(string guid)
        {
            return UserGetParticipantInfoAsync(guid, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <param name="guid">The guid of the user</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetParticipantInfoResponse> UserGetParticipantInfoAsync(string guid, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("user/getParticipantInfo");
    ...
    public partial class GetParticipantInfoResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("subRoleCd", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SubRoleCd { get; set; }
