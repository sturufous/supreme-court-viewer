//-------------- Note, take the BaseUrl out of the constructor for SCV. --------------
//----------------------
// <auto-generated>
...
namespace JCCommon.Clients.FileServices
{
    ...
    public partial class FileServicesClient
    {
        ...
        public async System.Threading.Tasks.Task<CourtList> FilesCourtlistAsync(string agencyId, string roomCd, string proceedingDt, string divisionCd, string fileNumber, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/courtlist?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CourtList>(response_, headers_).ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<RopResponse> FilesRecordOfProceedingsAsync(string partId, string profSeqNo, CourtLevelCd courtLevelCd, CourtClassCd courtClassCd, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/recordOfProceedings?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<RopResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
        ...
        public async System.Threading.Tasks.Task<DocumentResponse> FilesDocumentAsync(string documentId, string courtDivisionCd, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/document?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        return default(DocumentResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        public async System.Threading.Tasks.Task<FileSearchResponse> FilesCriminalAsync(string requestAgencyIdentifierId, string requestPartId, string applicationCd, SearchMode searchMode, string fileHomeAgencyId, string fileNumberTxt, string filePrefixTxt, string filePermissions, string fileSuffixNo, string mdocRefTypeCd, CourtClassCd2? courtClassCd, CourtLevelCd2? courtLevelCd, NameSearchTypeCd? nameSearchTypeCd, string lastNm, string orgNm, string givenNm, string birthDt, string searchByCrownPartId, SearchByCrownActiveOnlyYN? searchByCrownActiveOnlyYN, SearchByCrownFileDesignationCd? searchByCrownFileDesignationCd, string mdocJustinNoSet, string physicalFileIdSet, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/criminal?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<FileSearchResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(FileSearchResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/criminal/filecontent?");
            if (agencyId != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("agencyId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(agencyId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CriminalFileContent>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(CriminalFileContent);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        public async System.Threading.Tasks.Task<CriminalFileDetailResponse> FilesCriminalFileIdAsync(string requestAgencyIdentifierId, string requestPartId, string applicationCd, string fileId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/criminal/{fileId}");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CriminalFileDetailResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(CriminalFileDetailResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        public async System.Threading.Tasks.Task<CriminalFileAppearancesResponse> FilesCriminalFileIdAppearancesAsync(string requestAgencyIdentifierId, string requestPartId, FutureYN? futureYN, HistoryYN? historyYN, string fileId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/criminal/{fileId}/appearances?");
            urlBuilder_.Replace("{fileId}", System.Uri.EscapeDataString(ConvertToString(fileId, System.Globalization.CultureInfo.InvariantCulture)));
            if (futureYN != null)
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CriminalFileAppearancesResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(CriminalFileAppearancesResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        public async System.Threading.Tasks.Task<FileSearchResponse> FilesCivilAsync(string requestAgencyIdentifierId, string requestPartId, string applicationCd, SearchMode2 searchMode, string fileHomeAgencyId, string fileNumberTxt, string filePrefixTxt, string filePermissions, string fileSuffixNo, string mdocRefTypeCd, CourtClassCd3? courtClassCd, CourtLevelCd3? courtLevelCd, NameSearchTypeCd2? nameSearchTypeCd, string lastNm, string orgNm, string givenNm, string birthDt, string searchByCrownPartId, SearchByCrownActiveOnlyYN2? searchByCrownActiveOnlyYN, SearchByCrownFileDesignationCd2? searchByCrownFileDesignationCd, string mdocJustinNoSet, string physicalFileIdSet, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/civil?");
            urlBuilder_.Append(System.Uri.EscapeDataString("searchMode") + "=").Append(System.Uri.EscapeDataString(ConvertToString(searchMode, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append(System.Uri.EscapeDataString("fileHomeAgencyId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(fileHomeAgencyId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (fileNumberTxt != null)
            {
        ...
        /// <param name="requestPartId">Requesting Participant Id</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<CivilFileAppearancePartyResponse> FilesCivilAppearancesAppearanceIdPartyAsync(string requestAgencyIdentifierId, string requestPartId, string appearanceId)
        {
            return FilesCivilAppearancesAppearanceIdPartyAsync(requestAgencyIdentifierId, requestPartId, appearanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// <param name="requestPartId">Requesting Participant Id</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<CivilFileAppearancePartyResponse> FilesCivilAppearancesAppearanceIdPartyAsync(string requestAgencyIdentifierId, string requestPartId, string appearanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (appearanceId == null)
                throw new System.ArgumentNullException("appearanceId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/civil/appearances/{appearanceId}/party");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CivilFileAppearancePartyResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(CivilFileAppearancePartyResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <param name="requestPartId">Requesting Participant Id</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<CivilFileAppearanceApprMethodResponse> FilesCivilAppearancesAppearanceIdAppearancemethodAsync(string requestAgencyIdentifierId, string requestPartId, string appearanceId)
        {
            return FilesCivilAppearancesAppearanceIdAppearancemethodAsync(requestAgencyIdentifierId, requestPartId, appearanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// <param name="requestPartId">Requesting Participant Id</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<CivilFileAppearanceApprMethodResponse> FilesCivilAppearancesAppearanceIdAppearancemethodAsync(string requestAgencyIdentifierId, string requestPartId, string appearanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (appearanceId == null)
                throw new System.ArgumentNullException("appearanceId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/civil/appearances/{appearanceId}/appearancemethod");
            urlBuilder_.Replace("{appearanceId}", System.Uri.EscapeDataString(ConvertToString(appearanceId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CivilFileAppearanceApprMethodResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(CivilFileAppearanceApprMethodResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        public async System.Threading.Tasks.Task<JustinReportResponse> FilesCivilCourtsummaryreportAsync(string requestAgencyIdentifierId, string requestPartId, string appearanceId, string reportName, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/civil/courtsummaryreport?");
            urlBuilder_.Append(System.Uri.EscapeDataString("appearanceId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(appearanceId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<JustinReportResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(JustinReportResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <param name="appearanceId">The full appearance Id in the for 00000.0000</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<CivilFileContent> FilesCivilFilecontentAsync(string agencyId, string roomCd, string proceedingDt, string appearanceId, string physicalFileId)
        {
            return FilesCivilFilecontentAsync(agencyId, roomCd, proceedingDt, appearanceId, physicalFileId, System.Threading.CancellationToken.None);
        }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CivilFileContent>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(CivilFileContent);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <param name="requestPartId">Requesting Participant Id</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<CivilFileDetailResponse> FilesCivilFileIdAsync(string requestAgencyIdentifierId, string requestPartId, string fileId)
        {
            return FilesCivilFileIdAsync(requestAgencyIdentifierId, requestPartId, fileId, System.Threading.CancellationToken.None);
        }
        ...
        /// <param name="requestPartId">Requesting Participant Id</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<CivilFileDetailResponse> FilesCivilFileIdAsync(string requestAgencyIdentifierId, string requestPartId, string fileId, System.Threading.CancellationToken cancellationToken)
        {
            if (fileId == null)
                throw new System.ArgumentNullException("fileId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/civil/{fileId}");
            urlBuilder_.Replace("{fileId}", System.Uri.EscapeDataString(ConvertToString(fileId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CivilFileDetailResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(CivilFileDetailResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        public async System.Threading.Tasks.Task<CivilFileAppearancesResponse> FilesCivilFileIdAppearancesAsync(string requestAgencyIdentifierId, string requestPartId, FutureYN2? futureYN, HistoryYN2? historyYN, string fileId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/files/civil/{fileId}/appearances?");
            urlBuilder_.Replace("{fileId}", System.Uri.EscapeDataString(ConvertToString(fileId, System.Globalization.CultureInfo.InvariantCulture)));
            if (futureYN != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("futureYN") + "=").Append(System.Uri.EscapeDataString(ConvertToString(futureYN, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CivilFileAppearancesResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "404")
                        ...
                        return default(CivilFileAppearancesResponse);
                    }
                    finally
                    {
                        if (response_ != null)
