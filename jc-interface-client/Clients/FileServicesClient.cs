            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CourtCalendarDetailByDay>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(CourtCalendarDetailByDay);
                    }
                    finally
                    {
                        if (response_ != null)
